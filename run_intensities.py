...
def run_intensity_zscore(infile, outfolder):
    ...
    try:
        ...
        e = sys.exc_info()[0]
        print("Error: ", str(e))
        print("Error: execution z-score method")
        sys.exit(2)
...
def run_intensity_kde(infile, outfolder):
    ...
    try:
        ...
        e = sys.exc_info()[0]
        print("Error: ", str(e))
        print("Error: execution kde method")
        sys.exit(2)
...
def run_intensity_fcm(infile, outfolder):
    ...
    try:
        ...
        e = sys.exc_info()[0]
        print("Error: ", str(e))
        print("Error: execution histogram matching method")
        sys.exit(2)
...
def run_intensity_gmm(infile, outfolder):
    ...
    try:
        ...
        e = sys.exc_info()[0]
        print("Error: ", str(e))
        print("Error: execution gmm method")
        sys.exit(2)
...
def run_intensity_ws(infile, outfolder):
    ...
    try:
        ...
        e = sys.exc_info()[0]
        print("Error: ", str(e))
        print("Error: execution white stripe method")
        sys.exit(2)
...
def run_intensity_ravel(outfolder):
    ...
    try:
        ...
        e = sys.exc_info()[0]
        print("Error: ", str(e))
        print("Error: execution ravel method")
        sys.exit(2)
...
def run_intensity_hm(baselinedir,followupdir, outfolder):
    ...
    try:
        ...
        rename(join(outfolder, baselinedir), join(outfolder, baselinedir.split(".")[0]+"_hm.nii.gz"))
        rename(join(outfolder, followupdir), join(outfolder, followupdir.split(".")[0]+"_hm.nii.gz"))
    except:
        e = sys.exc_info()
        print(str(e))
        print("Error: ", str(e[0]))
